...
public class Order
{
	...
	{
		return "Order [numberTitle=" + numberTitle
				+ ", id=" + id + ", dateTitle=" + dateTitle + ", date=" + date
				+ ", clientTitle=" + clientTitle + ", client=" + client
				+ ", contactTitle=" + contactTitle + ", contact=" + contact
				+ ", phoneTitle=" + phoneTitle + ", phone=" + phone
				+ ", deviceTitle=" + deviceTitle + ", device=" + device
				+ ", snTitle=" + snTitle + ", sn=" + sn + ", typeRepairTitle="
				+ typeRepairTitle + ", typeRepair=" + typeRepair
				+ ", defectTitle=" + defectTitle + ", defect=" + defect
				+ ", completenessTitle=" + completenessTitle
				+ ", completeness=" + completeness + ", engineerTitle="
				+ engineerTitle + ", engineer=" + engineer + ", resultTitle="
				+ resultTitle + ", result=" + result + ", priceTitle="
				+ priceTitle + ", price=" + price + ", statusTitle="
